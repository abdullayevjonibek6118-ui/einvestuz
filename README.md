...
| `/ai` | Учебный помощник | Ответы по заранее заданным правилам о компаниях, показателях и рисках; справа отображается рыночный контекст. Генеративная AI-модель не подключена. Можно передать стартовый вопрос через `?question=...`. |
...
| `POST` | `/chat` | Получить образовательный ответ помощника MVP на основе правил. |
