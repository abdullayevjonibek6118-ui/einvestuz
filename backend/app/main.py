...
def _market_table_row_response(row: dict[str, Any]) -> MarketTableRow:
    return MarketTableRow(
        ...
        ticker=str(row.get("ticker") or ""),
        price=_optional_float_preserve_zero(row.get("price")),
        change_1h=_optional_float_preserve_zero(row.get("change_1h")),
        change_24h=_optional_float_preserve_zero(row.get("change_24h")),
        change_7d=_optional_float_preserve_zero(row.get("change_7d")),
        ...
        market_cap_value=_optional_float_preserve_zero(row.get("market_cap_value")),
        volume_24h_value=_optional_float_preserve_zero(row.get("volume_24h_value")),
        circulating_supply_value=_optional_float_preserve_zero(row.get("circulating_supply_value")),
